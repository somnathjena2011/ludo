		...
		if(a==6)
		{
			...
			else if(cells2[0].contains(a1)&&cells2[0].contains(a2)&&(preA1==6)&&(preA2==-1))
			{
				a1.onclick=function(){
					...
					cellA1=cellA1+a;
					turn=1;	  
					if(cells2[cellA1].contains(b1)&&cellA1!=0&&cellA1!=14&&cellA1!=13)
					{
						removed=cells2[cellA1].removeChild(b1);
						cells3[0].appendChild(removed);
					}
					else if(cells2[cellA1].contains(b2)&&cellA1!=0&&cellA1!=14&&cellA1!=13)
					{
				...
				if(cellA1+a<=27)
				{
					...
					a2.onclick=function(){
						...
						else if(preA2==6)
						{
				        	...
				        	cellA2=cellA2+a;
				        	turn=1;
				        	if(cells2[cellA2].contains(b1)&&cellA2!=0&&cellA2!=14&&cellA2!=13)
							{
								removed=cells2[cellA2].removeChild(b1);
								cells3[0].appendChild(removed);
							}
							else if(cells2[cellA2].contains(b2)&&cellA2!=0&&cellA2!=14&&cellA2!=13)
							{
		...
		if(a==6)
		{
			...
			else if(cells3[0].contains(b1)&&cells3[0].contains(b2)&&(preB1==6)&&(preB2==-1))
			{
				b1.onclick=function(){
					...
					cellB1=cellB1+a;
					turn=2;	
					if(cells3[cellB1].contains(a1)&&cellB1!=0&&cellB1!=14&&cellB1!=13)
					{
						removed=cells3[cellB1].removeChild(a1);
						cells2[0].appendChild(removed);
					}
					else if(cells3[cellB1].contains(a2)&&cellB1!=0&&cellB1!=14&&cellB1!=13)
					{
				...
				if(cellB1+a<=27)
				{
					...
					b2.onclick=function(){
						...
						else if(preB2==6)
						{
				        	...
				        	cellB2=cellB2+a;
				        	turn=2;
				        	if(cells3[cellB2].contains(a1)&&cellB2!=0&&cellB2!=14&&cellB2!=13)
							{
								removed=cells3[cellB2].removeChild(a1);
								cells2[0].appendChild(removed);
							}
							else if(cells3[cellB2].contains(a2)&&cellB2!=0&&cellB2!=14&&cellB2!=13)
							{
